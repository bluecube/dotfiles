...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Control" }, "Return", function () awful.util.spawn(terminal .. " -e ipython-3.4") end),
    ...
    awful.key({ "Shift"   }, "XF86AudioPlay",
        function () awful.util.spawn_with_shell('~/scripts/randomplaylist.sh') end),
    ...
    awful.key({ "Shift"   }, "XF86AudioPrev",
        function () awful.util.spawn('mpc seek -5') end),
